...
generalize. Cross-validation offers a principled way
...
generalization error than the training-set metric
alone.
...
reported R-squared is not an artifact of the
...
narrow interval suggests stable generalization across
folds.

![A sheet of graph paper with a hand-drawn scatter of
points, one small subset circled in pencil, a ruler laid
across the page](media/images/ambiance2.jpg){.img-fluid
...
- Geographic scope is restricted to Palmer Station,
  Antarctica, and may not generalize to penguin
...
model from Part 2 generalizes well to unseen data.
...
modeling exercise: always cross-validate before
...
confirms that the species-aware model generalizes
...
- General discussion of predictive modeling for
  ecological data
